...
public interface MemberRepo extends JpaRepository<Member,Long> {
    ...
    @Query("Select this_ from Member this_ where this_.id=:id and this_.refreshToken=:refresh")
    public Member findByIdAndToken(@Param("id") long id,@Param("refresh") String refresh);
